    ...
    <>
      ...
      <div className={styles.projectContainer} id="project">
        ...
        <div className={styles.descriptionContainer} id="funcionalidades">
          ...
          <div
            className={styles.descriptionBox}
            dangerouslySetInnerHTML={{ __html: project.useCase }}
          ></div>
          <div
...
export const getStaticProps: GetStaticProps = async (ctx) => {
  ...
  const projects = await db.collection("projects").findOne({ id: slug });
