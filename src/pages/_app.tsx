  ...
  return (
    <ProjectsProvider>
      <Head>
        ...
        <meta
          name="description"
          content="Desenvolvendo soluções FullStack eficientes com Javascript/Typescript/React"
        />
        <meta
          name="robots"
        ...
        <meta
          name="keywords"
          content="jefferson, portifólio dev, desenvolvedor"
        />

        <meta
          property="og:title"
          content="Jefferson | Desenvolvedor Web/FullStack"
        />
        <meta
